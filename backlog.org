...
*** WIP [Ralph] Design doc 001 - Hello World Route
:PROPERTIES:
:DESIGN: [[file:docs/design/001-hello-world-route.org][001 Hello World Route]]
:DELEGATED_TO: ralph
:PRD_FILES: tasks/prd-hello-world-route.json
:END:

Tasks from this design doc are being executed autonomously via Ralph.
Track progress in tasks/prd-hello-world-route.json and progress.txt.
